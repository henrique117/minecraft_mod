...
public class ModItems {
    ...
    public static final RegistryObject<Item> ENDWARP_INGOT = ITEMS.register("endwarp_ingot", () -> new ModItem(new Properties(), "endwarp_ingot"));
    ...
    public static final RegistryObject<Item> ENDWARP_SHARD = ITEMS.register("endwarp_shard", () -> new ModItem(new Properties(), "endwarp_shard"));
    ...
    public static final RegistryObject<BlockItem> NORMAL_ENDWARP_ORE_ITEM = ITEMS.register("normal_endwarp_ore", () -> new BlockItem(ModBlocks.NORMAL_ENDWARP_ORE.get(), new Properties()));
    ...
    public static final RegistryObject<BlockItem> BOOSTED_ENDWARP_ORE_ITEM = ITEMS.register("boosted_endwarp_ore", () -> new BlockItem(ModBlocks.BOOSTED_ENDWARP_ORE.get(), new Properties()));
